...
def page_new_url(url):
    ...
    url_list=root.xpath('//*[@id="wrapper"]/div[3]/div/div[2]/div/div[2]/div[2]/ul/li[]/a/@href') #爬内容的url
...
def spider(url):
    ...
    ##标题
    title=root.xpath('//*[@id="wrapper"]/div[3]/div/div[2]/div/div[2]/div[2]/form/div[1]/text()')
    title=''.join(title).replace('\xa0','')

    ##作者时间
    time=root.xpath('//*[@id="wrapper"]/div[3]/div/div[2]/div/div[2]/div[2]/form/div[2]/text()')
    time=''.join(time).replace('\xa0','')

    content=root.xpath('//*[@id="wrapper"]/div[3]/div/div[2]/div/div[2]/div[2]/form/div[3]//text()')
